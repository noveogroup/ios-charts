    ...
    open override func drawHighlighted(context: CGContext, indices: [Highlight])
    {
        ...
        for i in 0 ..< indices.count
        {
                ...
                (innerRadius > 0.0 || accountForSliceSpacing)
            {
                ...
                #if os(OSX)
                    bezierPath.appendArc(withCenter:
                ...
                context.setShadow(offset: CGSize(width: 0, height: 0), blur: 10, color: NSUIColor.darkGray.cgColor)
                NSUIColor.darkGray.setStroke()
